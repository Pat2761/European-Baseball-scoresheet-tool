 ...
 * </p>
 * <ul>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getPlateAppearances <em>Plate Appearances</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getAtBats <em>At Bats</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getRuns <em>Runs</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getHits <em>Hits</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getDouble <em>Double</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getTriple <em>Triple</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getHomerun <em>Homerun</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getGroundedDoublePlay <em>Grounded Double Play</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getSacrificeHit <em>Sacrifice Hit</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getSacrificeFly <em>Sacrifice Fly</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getBaseOnBall <em>Base On Ball</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getIntentionalbaseOnBall <em>Intentionalbase On Ball</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getHitByPitch <em>Hit By Pitch</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getInterferanceObstruction <em>Interferance Obstruction</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getStolenBase <em>Stolen Base</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getCaughtStealing <em>Caught Stealing</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getStrikeOut <em>Strike Out</em>}</li>
 *   <li>{@link org.bpy.score.reports.gamereports.impl.OffensiveStatisticImpl#getRbi <em>Rbi</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OffensiveStatisticImpl extends MinimalEObjectImpl.Container implements OffensiveStatistic {
	 ...
	 * @ordered
	 */
	protected static final int PLATE_APPEARANCES_EDEFAULT = -1;
	 ...
	 * @ordered
	 */
	protected static final int GROUNDED_DOUBLE_PLAY_EDEFAULT = -1;
	 ...
	 * @ordered
	 */
	protected static final int RBI_EDEFAULT = -1;
	...
	protected EClass eStaticClass() {
		return GameReportsPackage.Literals.OFFENSIVE_STATISTIC;
	}
	...
	public void setPlateAppearances(int newPlateAppearances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__PLATE_APPEARANCES, oldPlateAppearances, plateAppearances));
	}
	...
	public void setAtBats(int newAtBats) {
		...
		atBats = newAtBats;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__AT_BATS, oldAtBats, atBats));
	}
	...
	public void setRuns(int newRuns) {
		...
		runs = newRuns;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__RUNS, oldRuns, runs));
	}
	...
	public void setHits(int newHits) {
		...
		hits = newHits;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__HITS, oldHits, hits));
	}
	...
	public void setDouble(int newDouble) {
		...
		double_ = newDouble;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__DOUBLE, oldDouble, double_));
	}
	...
	public void setTriple(int newTriple) {
		...
		triple = newTriple;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__TRIPLE, oldTriple, triple));
	}
	...
	public void setHomerun(int newHomerun) {
		...
		homerun = newHomerun;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__HOMERUN, oldHomerun, homerun));
	}
	...
	public void setGroundedDoublePlay(int newGroundedDoublePlay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__GROUNDED_DOUBLE_PLAY, oldGroundedDoublePlay, groundedDoublePlay));
	}
	...
	public void setSacrificeHit(int newSacrificeHit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__SACRIFICE_HIT, oldSacrificeHit, sacrificeHit));
	}
	...
	public void setSacrificeFly(int newSacrificeFly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__SACRIFICE_FLY, oldSacrificeFly, sacrificeFly));
	}
	...
	public void setBaseOnBall(int newBaseOnBall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__BASE_ON_BALL, oldBaseOnBall, baseOnBall));
	}
	...
	public void setIntentionalbaseOnBall(int newIntentionalbaseOnBall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__INTENTIONALBASE_ON_BALL, oldIntentionalbaseOnBall, intentionalbaseOnBall));
	}
	...
	public void setHitByPitch(int newHitByPitch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__HIT_BY_PITCH, oldHitByPitch, hitByPitch));
	}
	...
	public void setInterferanceObstruction(int newInterferanceObstruction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__INTERFERANCE_OBSTRUCTION, oldInterferanceObstruction, interferanceObstruction));
	}
	...
	public void setStolenBase(int newStolenBase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__STOLEN_BASE, oldStolenBase, stolenBase));
	}
	...
	public void setCaughtStealing(int newCaughtStealing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__CAUGHT_STEALING, oldCaughtStealing, caughtStealing));
	}
	...
	public void setStrikeOut(int newStrikeOut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__STRIKE_OUT, oldStrikeOut, strikeOut));
	}
	...
	public void setRbi(int newRbi) {
		...
		rbi = newRbi;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameReportsPackage.OFFENSIVE_STATISTIC__RBI, oldRbi, rbi));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GameReportsPackage.OFFENSIVE_STATISTIC__PLATE_APPEARANCES:
				return getPlateAppearances();
			case GameReportsPackage.OFFENSIVE_STATISTIC__AT_BATS:
				return getAtBats();
			case GameReportsPackage.OFFENSIVE_STATISTIC__RUNS:
				return getRuns();
			case GameReportsPackage.OFFENSIVE_STATISTIC__HITS:
				return getHits();
			case GameReportsPackage.OFFENSIVE_STATISTIC__DOUBLE:
				return getDouble();
			case GameReportsPackage.OFFENSIVE_STATISTIC__TRIPLE:
				return getTriple();
			case GameReportsPackage.OFFENSIVE_STATISTIC__HOMERUN:
				return getHomerun();
			case GameReportsPackage.OFFENSIVE_STATISTIC__GROUNDED_DOUBLE_PLAY:
				return getGroundedDoublePlay();
			case GameReportsPackage.OFFENSIVE_STATISTIC__SACRIFICE_HIT:
				return getSacrificeHit();
			case GameReportsPackage.OFFENSIVE_STATISTIC__SACRIFICE_FLY:
				return getSacrificeFly();
			case GameReportsPackage.OFFENSIVE_STATISTIC__BASE_ON_BALL:
				return getBaseOnBall();
			case GameReportsPackage.OFFENSIVE_STATISTIC__INTENTIONALBASE_ON_BALL:
				return getIntentionalbaseOnBall();
			case GameReportsPackage.OFFENSIVE_STATISTIC__HIT_BY_PITCH:
				return getHitByPitch();
			case GameReportsPackage.OFFENSIVE_STATISTIC__INTERFERANCE_OBSTRUCTION:
				return getInterferanceObstruction();
			case GameReportsPackage.OFFENSIVE_STATISTIC__STOLEN_BASE:
				return getStolenBase();
			case GameReportsPackage.OFFENSIVE_STATISTIC__CAUGHT_STEALING:
				return getCaughtStealing();
			case GameReportsPackage.OFFENSIVE_STATISTIC__STRIKE_OUT:
				return getStrikeOut();
			case GameReportsPackage.OFFENSIVE_STATISTIC__RBI:
				return getRbi();
		}
