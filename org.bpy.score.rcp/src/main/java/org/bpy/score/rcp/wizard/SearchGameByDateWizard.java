 ...
 *
 */
public class SearchGameByDateWizard extends Wizard {
	
	/** Logger of the class */
	public static final Logger logger = Logger.getLogger(SearchGameByDateWizard.class.getSimpleName());

	/** Reference on the page one of the wizard */
	private SearchGameByDateWizardPageOne pageOne;
	 ...
	 */
	public SearchGameByDateWizard(IFolder folder) {
		setWindowTitle(Messages.SearchGameByDateWizard_WizardTitle);
	...
	public void addPages() {
		...
		pageOne = new SearchGameByDateWizardPageOne(this, currentFolder.getName());
		addPage(pageOne);
	}
