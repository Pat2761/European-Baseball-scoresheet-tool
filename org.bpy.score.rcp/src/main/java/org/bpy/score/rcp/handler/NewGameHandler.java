...
/**
 * This class active the new Game wizard. 
 * 
 * @author Patrick BRIAND
 *
 */
public class NewGameHandler implements IHandler {
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    NewGameWizard newGameWizard = new NewGameWizard(folder);
    WizardDialog wizardDialog = new WizardDialog(new Shell(), newGameWizard);
  ...
  public boolean isEnabled() {
	    ...
	    if (selection instanceof TreeSelection) {
	      ...
	      if (treeSelection.getFirstElement() instanceof IFolder) {
	        ...
	        return RcpUtils.isCategoryFolder(folder);
	      }
	    }
