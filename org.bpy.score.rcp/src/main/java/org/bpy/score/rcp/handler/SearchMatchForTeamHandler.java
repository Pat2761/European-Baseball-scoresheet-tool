...
import org.bpy.score.rcp.wizard.SearchGameForTeamWizard;
...
/**
 * This class execute the search game by team name menu
 * 
 * @author Patrick BRIAND
 *
 */
public class SearchMatchForTeamHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
	    ...
	    SearchGameForTeamWizard wizard = new SearchGameForTeamWizard(folder);
