 ...
 * </p>
 * <ul>
 *   <li>{@link org.bpy.score.engine.stats.emf.statistic.impl.DefensiveStatisticImpl#getPutOut <em>Put Out</em>}</li>
 *   <li>{@link org.bpy.score.engine.stats.emf.statistic.impl.DefensiveStatisticImpl#getAssitances <em>Assitances</em>}</li>
 *   <li>{@link org.bpy.score.engine.stats.emf.statistic.impl.DefensiveStatisticImpl#getErrors <em>Errors</em>}</li>
 *   <li>{@link org.bpy.score.engine.stats.emf.statistic.impl.DefensiveStatisticImpl#getDoublePlay <em>Double Play</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefensiveStatisticImpl extends MinimalEObjectImpl.Container implements DefensiveStatistic {
	 ...
	 * @ordered
	 */
	protected static final int PUT_OUT_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected static final int DOUBLE_PLAY_EDEFAULT = 0;
	...
	protected EClass eStaticClass() {
		return StatisticPackage.Literals.DEFENSIVE_STATISTIC;
	}
	...
	public void setPutOut(int newPutOut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatisticPackage.DEFENSIVE_STATISTIC__PUT_OUT, oldPutOut, putOut));
	}
	...
	public void setAssitances(int newAssitances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatisticPackage.DEFENSIVE_STATISTIC__ASSITANCES, oldAssitances, assitances));
	}
	...
	public void setErrors(int newErrors) {
		...
		errors = newErrors;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatisticPackage.DEFENSIVE_STATISTIC__ERRORS, oldErrors, errors));
	}
	...
	public void setDoublePlay(int newDoublePlay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatisticPackage.DEFENSIVE_STATISTIC__DOUBLE_PLAY, oldDoublePlay, doublePlay));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatisticPackage.DEFENSIVE_STATISTIC__PUT_OUT:
				return getPutOut();
			case StatisticPackage.DEFENSIVE_STATISTIC__ASSITANCES:
				return getAssitances();
			case StatisticPackage.DEFENSIVE_STATISTIC__ERRORS:
				return getErrors();
			case StatisticPackage.DEFENSIVE_STATISTIC__DOUBLE_PLAY:
