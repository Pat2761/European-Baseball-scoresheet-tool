...
import org.bpy.score.game.formatting2.GameFormatter;
import org.bpy.score.game.generator.GameGenerator;
import org.bpy.score.game.parser.antlr.GameAntlrTokenFileProvider;
import org.bpy.score.game.parser.antlr.GameParser;
import org.bpy.score.game.parser.antlr.internal.InternalGameLexer;
import org.bpy.score.game.scoping.GameScopeProvider;
import org.bpy.score.game.serializer.GameSemanticSequencer;
import org.bpy.score.game.serializer.GameSyntacticSequencer;
import org.bpy.score.game.services.GameGrammarAccess;
import org.bpy.score.game.validation.GameConfigurableIssueCodesProvider;
import org.bpy.score.game.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/bpy/score/game/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.bpy.score.game.Game");
	}
